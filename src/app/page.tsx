      ...
      <section className="relative min-h-[90vh] bg-navy-dark flex items-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="max-w-3xl">
            <p className="text-amber text-sm font-semibold uppercase tracking-[0.3em] mb-4">
              Long Beach Island, New Jersey
            </p>
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-none mb-6">
              Brewed at the Beach
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/our-beers" className="btn-primary text-base px-8 py-4">
                Explore Our Beers
              </Link>
              <Link href="/locations" className="btn-outline text-base px-8 py-4">
                Find a Taproom
              </Link>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-navy-dark rounded-lg p-8 text-center text-white">
                <div className="text-4xl font-bold text-amber mb-2">60+</div>
                <div className="text-sm text-gray-300 uppercase tracking-wider">
                  Beers Brewed
                </div>
              </div>
              <div className="bg-ocean rounded-lg p-8 text-center text-white">
                <div className="text-4xl font-bold text-amber mb-2">3</div>
                <div className="text-sm text-gray-200 uppercase tracking-wider">
                  Locations
                </div>
              </div>
              <div className="bg-amber rounded-lg p-8 text-center text-white">
                <div className="text-4xl font-bold mb-2">LBI</div>
              ...
              <div className="bg-navy-light rounded-lg p-8 text-center text-white">
                <div className="text-4xl font-bold text-amber mb-2">∞</div>
                <div className="text-sm text-gray-300 uppercase tracking-wider">
                  Good Vibes
                </div>
              </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 gap-4">
            <div>
              <p className="text-amber text-sm font-semibold uppercase tracking-[0.3em] mb-2">
                On Tap
              </p>
            ...
            <Link
              href="/our-beers"
              className="text-sm font-semibold text-navy-dark hover:text-amber transition-colors flex items-center gap-1 shrink-0"
            >
              View All Beers
              <svg
                className="w-4 h-4"
            ...
            {featuredBeers.map((beer) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-gray-400">{beer.category}</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {locations.map((loc) => (
              <div
                key={loc.slug}
                className="bg-navy-light/50 border border-navy-light rounded-xl p-6 hover:border-amber/50 transition-colors"
              >
                <h3 className="text-lg font-bold text-white mb-1">
                  {loc.name}
                </h3>
                <p className="text-amber text-sm mb-4">{loc.subtitle}</p>
                <p className="text-gray-400 text-sm mb-1">{loc.address}</p>
                <p className="text-gray-400 text-sm mb-4">
                  {loc.city}, {loc.state} {loc.zip}
                </p>
                <div className="border-t border-navy-light pt-4 mb-4">
                ...
                <a
                  ...
                  className="text-sm font-semibold text-amber hover:text-white transition-colors flex items-center gap-1"
                >
                  Get Directions
                  <svg
                    className="w-3 h-3"
